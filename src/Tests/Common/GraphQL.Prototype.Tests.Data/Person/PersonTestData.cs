namespace GraphQL.Prototype.Tests.Data.Person
{
    ...
    {
        public static List<GraphQL.Person.Domain.Entities.Person> SeedPersonTestData()
        {
            var people = new List<GraphQL.Person.Domain.Entities.Person>();

            people.Add(new GraphQL.Person.Domain.Entities.Person()
            {
